# SIGNAL — free-to-air TV browser

A single-page player frontend for two public, community-maintained M3U playlists:
...
HLS playback (hls.js), broadcast lower-third UI, incremental channel grid.
